...
def postprocess_mamba_fused_kernel(
    ...
    # DS conv row metadata (unused in Ascend path, kept for API compatibility)
    ...
    # Optional: batch_idx -> req_idx mapping (unused in V1, kept for API compatibility)
    idx_mapping_ptr,
    ...
    # CONV_STATE_DIM_FIRST: kept for API compatibility with upstream caller
    CONV_STATE_DIM_FIRST: tl.constexpr = False,
    # HAS_IDX_MAPPING: kept for API compatibility with upstream caller
    HAS_IDX_MAPPING: tl.constexpr = False,
    # PRECOMPUTED_NEW_COMPUTED: kept for API compatibility with upstream caller
